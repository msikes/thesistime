...
class AssetData {
	...
	public static function initialize ():Void {
		...
		if (!initialized) {
			...
			className.set ("assets/collision.bmp", nme.NME_assets_collision_bmp);
			type.set ("assets/collision.bmp", Reflect.field (AssetType, "binary".toUpperCase ()));
			className.set ("assets/collision.txt", nme.NME_assets_collision_txt);
			type.set ("assets/collision.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			...
			className.set ("assets/environment.png", nme.NME_assets_environment_png);
			type.set ("assets/environment.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class NME_assets_collision_bmp extends flash.utils.ByteArray { }
class NME_assets_collision_txt extends flash.utils.ByteArray { }
...
class NME_assets_environment_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
